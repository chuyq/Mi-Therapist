...
parser.add_argument("--max_input_length", type=int, default=140) #150
parser.add_argument("--max_decoder_input_length", type=int, default=60)
...
cmd = "--config_name emotion --inputter_name emotion --eval_input_file /mnt/storage/chuyuqi/code/data_lama/val_lama.txt --seed 13 --max_input_length 150 --max_decoder_input_length 50 --train_batch_size 16 --gradient_accumulation_steps 1 --eval_batch_size 16 --learning_rate 1e-5 --num_epochs 3 --warmup_steps 100 --fp16 false --loss_scale 0.0 --pbar true "
...
while True:
    ...
    for batch in train_dataloader:
        ...
        if step % args.gradient_accumulation_steps == 0:
            ...
            # if global_step % 10 == 0:# and epoch > 0:
